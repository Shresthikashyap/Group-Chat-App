...
const newGroup = async(event) =>{
    try{
        ...
        const response = await axios.post(`http://54.234.45.200:3000/group/new-group/${userId}`,newGroupDetails,{
        ...
        localStorage.setItem('link',`http://54.234.45.200:3000/signup.html?groupId=${groupId}`) // group link to share 
