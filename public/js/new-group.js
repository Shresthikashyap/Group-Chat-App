...
const newGroup = async(event) =>{
    try{
        ...
        const response = await axios.post(`http://23.20.253.19:3000/group/new-group/${userId}`,newGroupDetails,{
        ...
        localStorage.setItem('link',`http://23.20.253.19:3000/signup.html?groupId=${groupId}`) // group link to share 
