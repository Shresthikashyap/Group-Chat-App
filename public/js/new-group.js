...
const newGroup = async(event) =>{
    try{
        ...
        const response = await axios.post(`http://54.161.13.80:3000/group/new-group/${userId}`,newGroupDetails,{
        ...
        localStorage.setItem('link',`http://54.161.13.80:3000/signup.html?groupId=${groupId}`) // group link to share 
